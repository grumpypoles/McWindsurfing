...
import { duplicateSport } from "@/app/_lib/actions_masts";

function DuplicateSport({ copiedRow, onDelete }) {
  const [isPending, startTransition] = useTransition();

  function handleDuplicate() {
    if (confirm("Are you sure you want to duplicate this record?"))
      startTransition(() => duplicateSport(copiedRow));
