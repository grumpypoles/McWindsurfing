...
const LocationGrid = ({ rowData, sports }) => {
...
const sportsList = sports.map((item) => item.sport)

  const [colDefs] = useState([
    { field: "spot", minWidth: 300, filter: true, editable: false, },
    { field: "sport", 
      headerName: "Select Sport",
    ...
    { field: "longitude", filter: true,  editable: true, },
    // { field: "is_active", maxWidth: 110, headerName: "Status", editable: false, },
    {
      field: "custom",
      headerName: "Details",
      maxWidth: 125,
