...
import { duplicateWindPower } from "@/app/_lib/actions_masts";

function DuplicateWindPower({ copiedRow, onDelete }) {
  const [isPending, startTransition] = useTransition();

  function handleDuplicate() {
    if (confirm("Are you sure you want to duplicate this record?"))
      startTransition(() => duplicateWindPower(copiedRow));
...
export default DuplicateWindPower;
