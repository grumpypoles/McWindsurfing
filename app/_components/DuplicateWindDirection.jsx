...
import { duplicateWindDirection } from "@/app/_lib/actions_masts";

function DuplicateWindDirection({ copiedRow, onDelete }) {
  const [isPending, startTransition] = useTransition();

  function handleDuplicate() {
    if (confirm("Are you sure you want to duplicate this record?"))
      startTransition(() => duplicateWindDirection(copiedRow));
...
export default DuplicateWindDirection;
